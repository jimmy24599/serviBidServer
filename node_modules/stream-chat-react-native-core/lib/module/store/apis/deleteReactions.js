...
var deleteReactionsForMessage = exports.deleteReactionsForMessage = function () {
  var _ref2 = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee(_ref) {
    var _ref$flush, flush, messageId, query;
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _ref$flush = _ref.flush, flush = _ref$flush === void 0 ? true : _ref$flush, messageId = _ref.messageId;
          query = (0, _createDeleteQuery.createDeleteQuery)('reactions', {
            messageId: messageId
          });
