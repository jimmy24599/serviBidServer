...
var isMaxNumberOfVotesValid = exports.isMaxNumberOfVotesValid = function isMaxNumberOfVotesValid(maxNumberOfVotes) {
...
var CreatePoll = exports.CreatePoll = function CreatePoll(_ref2) {
  var closePollCreationDialog = _ref2.closePollCreationDialog,
    CreatePollContentOverride = _ref2.CreatePollContent,
    createPollOptionHeight = _ref2.createPollOptionHeight,
  ...
  var createAndSendPoll = (0, _react.useCallback)(function () {
    var _ref3 = (0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee(pollData) {
      var poll;
