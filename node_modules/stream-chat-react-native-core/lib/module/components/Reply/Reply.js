...
var ReplyWithContext = function ReplyWithContext(props) {
  var _poll_id, _useStateStore, _quotedMessage$attach, _stylesProp$imageAtta, _stylesProp$imageAtta2, _stylesProp$imageAtta3, _stylesProp$imageAtta4, _stylesProp$fileAttac;
  ...
  var poll = client.polls.fromState((_poll_id = quotedMessage == null ? void 0 : quotedMessage.poll_id) != null ? _poll_id : '');
