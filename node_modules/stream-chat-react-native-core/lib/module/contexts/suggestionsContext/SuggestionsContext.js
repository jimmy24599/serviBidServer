...
exports.useSuggestionsContext = exports.isSuggestionUser = exports.isSuggestionEmoji = exports.isSuggestionCommand = exports.SuggestionsProvider = exports.SuggestionsContext = void 0;
...
var isSuggestionCommand = exports.isSuggestionCommand = function isSuggestionCommand(suggestion) {
  return 'args' in suggestion;
};
var isSuggestionEmoji = exports.isSuggestionEmoji = function isSuggestionEmoji(suggestion) {
  return 'unicode' in suggestion;
};
var isSuggestionUser = exports.isSuggestionUser = function isSuggestionUser(suggestion) {
  return 'id' in suggestion;
};
var SuggestionsContext = exports.SuggestionsContext = _react["default"].createContext(_defaultBaseContextValue.DEFAULT_BASE_CONTEXT_VALUE);
var SuggestionsProvider = exports.SuggestionsProvider = function SuggestionsProvider(_ref) {
...
var useSuggestionsContext = exports.useSuggestionsContext = function useSuggestionsContext() {
