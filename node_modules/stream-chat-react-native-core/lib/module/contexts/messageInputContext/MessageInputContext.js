...
var MessageInputProvider = exports.MessageInputProvider = function MessageInputProvider(_ref) {
  ...
  var getFileUploadConfig = function getFileUploadConfig() {
    ...
    var fileConfig = appSettings == null || (_appSettings$app = appSettings.app) == null ? void 0 : _appSettings$app.file_upload_config;
  ...
  var getImageUploadConfig = function getImageUploadConfig() {
    ...
    var imageConfig = appSettings == null || (_appSettings$app2 = appSettings.app) == null ? void 0 : _appSettings$app2.image_upload_config;
  ...
  var editing = value.editing,
    ...
    StopMessageStreamingButton = value.StopMessageStreamingButton;
  ...
  var isValidMessage = function isValidMessage() {
    ...
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        ...
        if (!_file || _file.state === _utils2.FileState.UPLOAD_FAILED) {
          continue;
        }
        if (_file.state === _utils2.FileState.UPLOADING) {
          return false;
        }
        return true;
      }
      ...
      return _regenerator["default"].wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            closePicker();
            _context.next = 4;
            return _native.NativeHandlers.takePhoto({
