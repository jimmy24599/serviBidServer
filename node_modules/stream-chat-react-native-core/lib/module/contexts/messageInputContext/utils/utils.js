...
var MAX_FILE_SIZE_TO_UPLOAD = exports.MAX_FILE_SIZE_TO_UPLOAD = 100 * 1024 * 1024;
var isUploadAllowed = exports.isUploadAllowed = function isUploadAllowed(_ref) {
  ...
  if (allowed_mime_types != null && allowed_mime_types.length) {
    if (file.mimeType) {
      var _allowed = allowed_mime_types.some(function (mimeType) {
        return file.mimeType && file.mimeType.toLowerCase() === mimeType.toLowerCase();
      });
      if (!_allowed) {
        return false;
      }
      ...
      var _allowed2 = allowed_mime_types.some(function (mimeType) {
  ...
  if (blocked_mime_types != null && blocked_mime_types.length) {
    if (file.mimeType) {
      ...
      var _blocked2 = blocked_mime_types.some(function (mimeType) {
