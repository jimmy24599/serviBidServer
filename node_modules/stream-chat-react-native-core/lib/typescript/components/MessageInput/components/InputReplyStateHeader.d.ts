...
export declare const InputReplyStateHeader: {
    <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>({ clearQuotedMessageState: propClearQuotedMessageState, resetInput: propResetInput, }: InputReplyStateHeaderProps<StreamChatGenerics>): React.JSX.Element;
    displayName: string;
};
