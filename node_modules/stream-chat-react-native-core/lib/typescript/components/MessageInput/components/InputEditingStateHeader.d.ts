...
export declare const InputEditingStateHeader: {
    <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>({ clearEditingState: propClearEditingState, resetInput: propResetInput, }: InputEditingStateHeaderProps<StreamChatGenerics>): React.JSX.Element;
    displayName: string;
};
