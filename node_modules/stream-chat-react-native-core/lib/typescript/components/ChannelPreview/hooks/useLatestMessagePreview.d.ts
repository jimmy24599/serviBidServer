 ...
 */
export declare const useLatestMessagePreview: <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>(channel: Channel<StreamChatGenerics>, forceUpdate: number, lastMessage?: ReturnType<ChannelState<StreamChatGenerics>["formatMessage"]> | MessageResponse<StreamChatGenerics>) => {
    created_at: string | Date | undefined;
    messageObject: MessageResponse<StreamChatGenerics> | import("stream-chat").FormatMessageResponse<StreamChatGenerics> | undefined;
    previews: {
        bold: boolean;
        text: string;
    }[];
