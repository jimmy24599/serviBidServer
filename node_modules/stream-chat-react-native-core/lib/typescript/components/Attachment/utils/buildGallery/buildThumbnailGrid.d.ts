 ...
 */
export declare function buildThumbnailGrid<StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>({ grid, images, invertedDirections, resizableCDNHosts, sizeConfig, }: Pick<ChatConfigContextValue, 'resizableCDNHosts'> & {
    grid: number[][];
