...
type ThreadPropsWithContext<StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics> = Pick<ChatContextValue<StreamChatGenerics>, 'client'> & Pick<MessagesContextValue<StreamChatGenerics>, 'MessageList'> & Pick<ThreadContextValue<StreamChatGenerics>, 'closeThread' | 'loadMoreThread' | 'parentMessagePreventPress' | 'reloadThread' | 'thread' | 'threadInstance'> & {
    /**
 ...
 */
export declare const Thread: <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>(props: ThreadProps<StreamChatGenerics>) => React.JSX.Element;
export {};
