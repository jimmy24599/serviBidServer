...
export declare const MessageTextContainer: {
    <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>(props: MessageTextContainerProps<StreamChatGenerics>): React.JSX.Element;
    displayName: string;
};
