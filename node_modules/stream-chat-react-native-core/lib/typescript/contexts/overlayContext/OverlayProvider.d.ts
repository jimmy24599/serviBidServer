 ...
 */
export declare const OverlayProvider: <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>(props: PropsWithChildren<OverlayProviderProps<StreamChatGenerics>>) => React.JSX.Element;
