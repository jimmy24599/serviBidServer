...
export type MessageContentType = 'attachments' | 'files' | 'gallery' | 'quoted_reply' | 'poll' | 'ai_text' | 'text';
export type DeletedMessagesVisibilityType = 'always' | 'never' | 'receiver' | 'sender';
export type MessagesContextValue<StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics> = Pick<MessageContextValue<StreamChatGenerics>, 'isMessageAIGenerated'> & {
    /**
...
export declare const MessagesProvider: <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>({ children, value, }: PropsWithChildren<{
