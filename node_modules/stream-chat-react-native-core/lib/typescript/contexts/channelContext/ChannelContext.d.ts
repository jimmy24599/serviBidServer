...
export type ChannelContextValue<StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics> = {
    ...
    loadChannelAtFirstUnreadMessage: ({ channelUnreadState, limit, setTargetedMessage, }: {
        ...
        limit?: number;
        setChannelUnreadState?: React.Dispatch<React.SetStateAction<ChannelUnreadState<StreamChatGenerics> | undefined>>;
        setTargetedMessage?: (messageId: string) => void;
    }) => Promise<void>;
    /**
...
export declare const ChannelProvider: <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>({ children, value, }: PropsWithChildren<{
