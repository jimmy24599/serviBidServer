    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          uri = image.uri || '';
          _context.next = 3;
          return image.source === 'camera' || !image.height || !image.width || typeof compressImageQuality !== 'number' || compressImageQuality === 1 ? uri : _native.NativeHandlers.compressImage({
