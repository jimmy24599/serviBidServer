...
var MessageInputWithContext = function MessageInputWithContext(props) {
    ...
    return Object.assign({}, additionalTextInputProps, {
      onBlur: function onBlur(event) {
        if (additionalTextInputProps != null && additionalTextInputProps.onBlur) {
          additionalTextInputProps == null || additionalTextInputProps.onBlur(event);
        }
        if (setFocused) {
          setFocused(false);
        }
  ...
  return (0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
    ...
    }), showPollCreationDialog ? (0, _jsxRuntime.jsx)(_reactNative.View, {
      style: {
        alignItems: 'center',
        flex: 1,
...
var MessageInput = exports.MessageInput = function MessageInput(props) {
  ...
  var _useChannelContext2 = (0, _ChannelContext.useChannelContext)(),
    members = _useChannelContext2.members,
    threadList = _useChannelContext2.threadList,
    watchers = _useChannelContext2.watchers;
